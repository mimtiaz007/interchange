...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/mimtiaz007/interchange/ibcdex/buyOrderBook
   */
  queryBuyOrderBookAll = (
    ...
    this.request<IbcdexQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/mimtiaz007/interchange/ibcdex/buyOrderBook`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mimtiaz007/interchange/ibcdex/buyOrderBook/{index}
   */
  queryBuyOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<IbcdexQueryGetBuyOrderBookResponse, RpcStatus>({
      path: `/mimtiaz007/interchange/ibcdex/buyOrderBook/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/mimtiaz007/interchange/ibcdex/denomTrace
   */
  queryDenomTraceAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<IbcdexQueryAllDenomTraceResponse, RpcStatus>({
      path: `/mimtiaz007/interchange/ibcdex/denomTrace`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mimtiaz007/interchange/ibcdex/denomTrace/{index}
   */
  queryDenomTrace = (index: string, params: RequestParams = {}) =>
    this.request<IbcdexQueryGetDenomTraceResponse, RpcStatus>({
      path: `/mimtiaz007/interchange/ibcdex/denomTrace/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/mimtiaz007/interchange/ibcdex/sellOrderBook
   */
  querySellOrderBookAll = (
    ...
    this.request<IbcdexQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/mimtiaz007/interchange/ibcdex/sellOrderBook`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mimtiaz007/interchange/ibcdex/sellOrderBook/{index}
   */
  querySellOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<IbcdexQueryGetSellOrderBookResponse, RpcStatus>({
      path: `/mimtiaz007/interchange/ibcdex/sellOrderBook/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
