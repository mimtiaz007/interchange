...
export const protobufPackage = 'mimtiaz007.interchange.ibcdex'
...
export class QueryClientImpl implements Query {
  ...
  DenomTrace(request: QueryGetDenomTraceRequest): Promise<QueryGetDenomTraceResponse> {
    ...
    const promise = this.rpc.request('mimtiaz007.interchange.ibcdex.Query', 'DenomTrace', data)
  ...
  DenomTraceAll(request: QueryAllDenomTraceRequest): Promise<QueryAllDenomTraceResponse> {
    ...
    const promise = this.rpc.request('mimtiaz007.interchange.ibcdex.Query', 'DenomTraceAll', data)
  ...
  BuyOrderBook(request: QueryGetBuyOrderBookRequest): Promise<QueryGetBuyOrderBookResponse> {
    ...
    const promise = this.rpc.request('mimtiaz007.interchange.ibcdex.Query', 'BuyOrderBook', data)
  ...
  BuyOrderBookAll(request: QueryAllBuyOrderBookRequest): Promise<QueryAllBuyOrderBookResponse> {
    ...
    const promise = this.rpc.request('mimtiaz007.interchange.ibcdex.Query', 'BuyOrderBookAll', data)
  ...
  SellOrderBook(request: QueryGetSellOrderBookRequest): Promise<QueryGetSellOrderBookResponse> {
    ...
    const promise = this.rpc.request('mimtiaz007.interchange.ibcdex.Query', 'SellOrderBook', data)
  ...
  SellOrderBookAll(request: QueryAllSellOrderBookRequest): Promise<QueryAllSellOrderBookResponse> {
    ...
    const promise = this.rpc.request('mimtiaz007.interchange.ibcdex.Query', 'SellOrderBookAll', data)
